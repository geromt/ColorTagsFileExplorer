...
from PyQt5.QtWidgets import QApplication, QMainWindow, QFileSystemModel, QVBoxLayout, QWidget, QListView, QTreeView, \
...
class FileExplorerApp(QMainWindow):
    def __init__(self):
        ...
        button = QPushButton('Folder Up')
        button.clicked.connect(self.go_folder_up)
    ...
    def init_ui(self):
        ...
        delegate = ColorDelegate(self.list_selection_model, self.file_model, self.list_view)
